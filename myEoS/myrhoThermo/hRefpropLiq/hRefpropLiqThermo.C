...
template<class equationOfState>
Foam::hRefpropLiqThermo<equationOfState>::hRefpropLiqThermo(const dictionary& dict)
:
...
template<class equationOfState>
void Foam::hRefpropLiqThermo<equationOfState>::write(Ostream& os) const
{
...
)
{
    ...
    os.check("Ostream& operator<<(Ostream& os, const hRefpropLiqThermo& ct)");
    return os;
}
